...
const months: { name: string; year: number; events: Event[] }[] = [
  {
    ...
    events: [
      ...
      { day: "19", weekday: "Sun", time: "11:00 AM – 12:30 PM", title: "Kids' Art Club", level: "Ages 6–12", img: kids, location: "West Windsor Studio" },
  ...
  },
  {
    ...
    events: [
      ...
      { day: "9", weekday: "Sun", time: "11:00 AM – 12:30 PM", title: "Kids' Art Club", level: "Ages 6–12", img: kids, location: "West Windsor Studio" },
  ...
  },
  {
    ...
    events: [
      ...
      { day: "13", weekday: "Sun", time: "11:00 AM – 12:30 PM", title: "Kids' Art Club", level: "Ages 6–12", img: kids, location: "West Windsor Studio" },
