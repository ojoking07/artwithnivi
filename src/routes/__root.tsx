...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Nivi Arts Studio — Art Experiences in Central NJ" },
      { name: "twitter:description", content: "Artist-led sip-and-paint nights, private parties, corporate workshops, and weekend art classes in Princeton, West Windsor & beyond." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/ff0419a4-f67d-41b9-a8d4-f79b0f6ffea8" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/ff0419a4-f67d-41b9-a8d4-f79b0f6ffea8" },
    ],
    links: [
